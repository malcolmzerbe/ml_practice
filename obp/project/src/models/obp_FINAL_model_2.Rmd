---
title: "Predict OBP Final Model (2)"
date: "7/24/2022"
...
obp_dt_rmse <- readRDS('./project/volume/data/processed/obp_dt_rmse_2.rds')
obp_dt_mae <- readRDS('./project/volume/data/processed/obp_dt_mae_2.rds')

obp_rf_rmse <- readRDS('./project/volume/data/processed/obp_rf_rmse_2.rds')
obp_rf_mae <- readRDS('./project/volume/data/processed/obp_rf_mae_2.rds')

obp_gbt_rmse <- readRDS('./project/volume/data/processed/obp_gbt_rmse_2.rds')
obp_gbt_mae <- readRDS('./project/volume/data/processed/obp_gbt_mae_2.rds')

obp_lr_rmse <- readRDS('./project/volume/data/processed/obp_lr_rmse_2.rds')
obp_lr_mae <- readRDS('./project/volume/data/processed/obp_lr_mae_2.rds')

obp_svm_rmse <- readRDS('./project/volume/data/processed/obp_svm_rmse_2.rds')
obp_svm_mae <- readRDS('./project/volume/data/processed/obp_svm_mae_2.rds')

obp_knn_rmse <- readRDS('./project/volume/data/processed/obp_knn_rmse_2.rds')
obp_knn_mae <- readRDS('./project/volume/data/processed/obp_knn_mae_2.rds')
```
...
obp_final_spec <- svm_rbf(cost = 10.07937,
...
saveRDS(obp_final_fit, './project/volume/models/obp_final_fit_2.model')
```

```{r}
# inspect variable importance not available for svm
#obp_final_fit %>% extract_fit_parsnip() %>% vip(num_features = 20)
```

```{r}
# determine null error for all players
obp_tbl <- read.csv('./project/volume/data/interim/obp_tbl_2.csv',
                      stringsAsFactors = TRUE)
