---
title: "Predict OBP K-Nearest Neighbors Model (1)"
date: "7/23/2022"
...
```{r}
# collect cv results
saveRDS(obp_knn_res, './project/volume/models/obp_knn_res_1.rds')
...
obp_knn_metric[obp_knn_metric$.config == 'Preprocessor1_Model0740',]
```

```{r}
# record results for final model selection
obp_knn_rmse <- 0.03021070
saveRDS(obp_knn_rmse, './project/volume/data/processed/obp_knn_rmse_1.rds')
obp_knn_mae <- 0.02395995
saveRDS(obp_knn_mae, './project/volume/data/processed/obp_knn_mae_1.rds')
```
