---
title: "Predict OBP Random Forest Model (1)"
date: "7/23/2022"
...
obp_rf_grid <- grid_regular(mtry(range = c(1, 25)),
                            trees(),
                            min_n(),
                            levels = 10)
obp_rf_grid
...
```{r}
# collect cv results
saveRDS(obp_rf_res, './project/volume/models/obp_rf_res_1.rds')
...
obp_rf_metric[obp_rf_metric$.config == 'Preprocessor1_Model0015',]
```

```{r}
# record results for final model selection
obp_rf_rmse <- 0.02838279
saveRDS(obp_rf_rmse, './project/volume/data/processed/obp_rf_rmse_1.rds')
obp_rf_mae <- 0.02277448
saveRDS(obp_rf_mae, './project/volume/data/processed/obp_rf_mae_1.rds')
```
